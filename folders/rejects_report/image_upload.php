...
// Fetch images from database where ticket_no matches ticket_number
$images = [];
if (!empty($ticket_no)) {
...
// Close the database connection for `image_upload.php`
$conn->close();
?>
...
<!-- Image Upload Section (from image_upload.php) -->
<!-- Image Upload Section (from image_upload.php) -->
<div class="container image-upload-section"> <!-- Added image-upload-section class -->
    <div class="row">
        <div class="col-md-12 custom-header">
            <h3 class="text-center">Images for Ticket Number: <?= htmlspecialchars($ticket_no); ?></h3>
            ...
            <div class="btn-group d-flex justify-content-end">
                <a href="javascript:window.close();" class="btn btn-cancel ml-2">Close</a>
            </div>
        </div>
    </div>
</div>
