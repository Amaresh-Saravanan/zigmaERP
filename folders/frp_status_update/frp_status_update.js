...
var form_name 		= 'frp_status_update';
var form_header		= '';
var form_footer 	= '';
var table_name 		= '';
var table_id 		= 'frp_status_update_datatable';
var action 			= "datatable";

function frp_status_update_cu(unique_id = "") {
...
function frp_status_update_delete(unique_id = "" ,batch_id1 ) {
	var ajax_url = sessionStorage.getItem("folder_crud_link");
	var url      = sessionStorage.getItem("list_link");
	// alert(batch_id1);
...
function print_view(file_name) {
    onmouseover = window.open('uploads/frp_status_update/' + file_name, 'onmouseover', 'height=600,width=900,scrollbars=yes,resizable=no,left=200,top=150,toolbar=no,location=no,directories=no,status=no,menubar=no');
}
