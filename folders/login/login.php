...
<head>
  ...
  <link rel="" type="image/x-icon"  href="assets/images/favi-icon.png">
  <!-- Layout config Js -->
            ...
            <div class="card mt-4 card-bg-fill">
              <div class="card-body p-4">
                <div class="text-center mt-2">
                  ...
                  <p class="text-muted">Sign in to continue to Zigfly.</p>
                </div>
                <div class="p-2 mt-4">
                  <form>
                    <div class="mb-3">
          ...
          <div class="col-lg-12">
            <div class="text-center">
              <p class="mb-0 text-muted">&copy;
                <script>document.write(new Date().getFullYear())</script> Zigfly. Crafted with <i
                  class="mdi mdi-heart text-danger"></i> by Zigma
              </p>
            </div>
          </div>
        </div>
