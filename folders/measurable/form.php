        ...
        <form class="was-validated" autocomplete="off">
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              ...
              <input type="number" step="0.01" class="form-control" id="temp" name="temp" value="<?php echo $temp; ?>" required>
            </div>

            <div class="col-md-3">
              <label for="humi" class="form-label">Humidity (%)</label>
              <input type="number" step="0.01" name="humi" id="humi" class="select2 form-control" value="<?php echo $humi; ?>" required>
            </div>
          </div>
