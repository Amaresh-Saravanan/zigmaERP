...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.user_name || !form.password) {
      // ponytail: empty case handled by client interceptor via msg=''empty'' — but login does client-side check first
  ...
  // Enter key support (mirrors login.js lines 307-311)
