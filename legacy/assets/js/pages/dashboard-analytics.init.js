...
function loadCharts() {
    ...
    if ((e = getChartColorsArray("countries_charts"))) {
        const r = {
            ...
            legend: { show: !1 },
            grid: { show: !1 },
            xaxis: { categories: ["PIT 1", "PIT 2", "PIT 3", "PIT 4", "PIT 5", "PIT 6", "PIT 7", "PIT 8", "PIT 9", "PIT 10"] },
        };
    ...
    (e = getChartColorsArray("user_device_pie_charts")) &&
        ...
        (userDevicePieCharts = new ApexCharts(document.querySelector("#user_device_pie_charts"), r)).render());
}
